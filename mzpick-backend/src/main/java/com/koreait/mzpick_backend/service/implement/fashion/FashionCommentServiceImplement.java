...
public class FashionCommentServiceImplement implements FashionCommentService{
    ...
    @Override
    public ResponseEntity<ResponseDto> getComment(Integer fashionNumber) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getComment'");
    }

    @Override
    public ResponseEntity<ResponseDto> postComment(Integer fashionNumber, String userId) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'postComment'");
    }

    @Override
    public ResponseEntity<ResponseDto> deleteComment(Integer fashionCommentNumber) {
        // TODO Auto-generated method stub
